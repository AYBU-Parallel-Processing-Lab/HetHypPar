...
//-------------------------------------------------------------------------------------------------------
    ...
    Vector X = vector_read(arguments.input_x, rmatrix.n);
    Vector B = vector_read(arguments.input_y, rmatrix.m);
...
//-------------------------------------------------------------------------------------------------------
    ...
    // CPU Objects
    Vector Y = vector_init_const(rmatrix.m, 0);
...
//-------------------------------------------------------------------------------------------------------
    ...
    for (size_t i = 0; i < niters; i++)
    {
        ...
        //==============
        // calc V_n+1
        CSR_spmxv_seq(rmatrix, P, V); // result in V
        //==============
        // calc alpha_n+1
